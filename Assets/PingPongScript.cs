        ...
        if(Input.touchCount > 0)
        {
            ...
            switch (touch.phase)
            {
                ...
                case TouchPhase.Ended:
                    ...
                    //pingPongBall = Instantiate(pingPongBall, pingPongBall.transform.position, Quaternion.identity);
                    //Destroy(gameObject, 3f);
                    //TODO: Create spawnball script under main camera then instantiate from here
                    break;
            }
        }
    }
